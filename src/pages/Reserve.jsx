...
function Reserve() {
    ...
    const handleChangeSchool = (e) => {
        ...
        if (checked) {
            ...
            setSchoolFormData({
                ...schoolFormData, selectedServices: schoolFormData.selectedServices.filter((service) => {
    ...
    const handleChangeNeil = (e) => {
        ...
        if (checked) {
            ...
            setNeilFormData({
                ...neilFormData, selectedServices: neilFormData.selectedServices.filter((service) => {
                    return service !== value;
                }),
            });
        }
